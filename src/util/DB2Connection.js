  ...
  async addL0TOL1Reporting(payload) {
    ...
    try {
      ...
      if (!payload.CUSTOMER_CONVERSION_DATE) {
        query = `INSERT INTO COMMON.L0_TO_L1_REPORT (CUSTOMER_MSISDN, CUSTOMER_PREVIOUS_STATUS, CUSTOMER_NEW_STATUS, CUSTOMER_LEVEL, CUSTOMER_REGISTERATION_DATE, STATUS )
        VALUES
        (
